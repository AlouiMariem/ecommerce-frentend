      ...
      <ScrollView style={styles.bodyContainer} nestedScrollEnabled={true}>
        ...
        <View style={styles.totalOrderInfoContainer}>
          <View style={styles.list}>
            <Text>Order</Text>
            <Text>{totalCost}DT</Text>
          </View>
          <View style={styles.list}>
            <Text>Delivery</Text>
            <Text>{deliveryCost}DT</Text>
          </View>
          <View style={styles.list}>
            <Text style={styles.primaryTextSm}>Total</Text>
            <Text style={styles.secondaryTextSm}>
              {totalCost + deliveryCost}DT
            </Text>
          </View>
        </View>
        ...
        <View style={styles.listContainer}>
          <View style={styles.list}>
            ...
            <Text style={styles.secondaryTextSm}>
              dermo_relax@gmail.com
            </Text>
          </View>
          <View style={styles.list}>
            <Text style={styles.secondaryTextSm}>Phone</Text>
            <Text style={styles.secondaryTextSm}>71000111</Text>
          </View>
        </View>
        ...
        <View style={styles.listContainer}>
          <View style={styles.list}>
            ...
            <Text style={styles.primaryTextSm}>Paiement à la livraison</Text>
          </View>
        </View>
