...
const category = [
  ...
  },
  {
    ...
    title: "Lotion",
    image: require("../../assets/icons/lotion.png"),
  },
  {
  ...
  },
  {
    ...
    title: "Gels Douche",
    image: require("../../assets/icons/gels.png"),
  },
];

const slides = [
  require("../../assets/image/banners/s.png"),
  require("../../assets/image/banners/f.png"),
  require("../../assets/image/banners/i.png"),
];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBarContainer}>
        ...
        <View style={styles.topbarlogoContainer}>
          ...
          <Text style={styles.toBarText}>DERMO RELAX</Text>
        </View>
        <TouchableOpacity
      ...
      <View style={styles.bodyContainer}>
        ...
        <ScrollView nestedScrollEnabled={true}>
          ...
          <View style={styles.primaryTextContainer}>
            <Text style={styles.primaryText}>Nos Catégories</Text>
          </View>
          ...
          <View style={styles.primaryTextContainer}>
            <Text style={styles.primaryText}>Nos Produits</Text>
          </View>
          {products.length === 0 ? (
